...
public class SimpleStereogram {
    ...
    //added Nick Meyer 2/12/14
    public static void main(String[] args) {
        new SimpleStereogram().generateTexturedSIRD();
    }

    public void generateSIRD() {
        BufferedImage depthMap = getImage("./images/depthMaps/Dino.jpg");
    ...
    public void generateTexturedSIRD() {
        BufferedImage depthMap = getImage("./images/depthMaps/Dino.jpg");
        BufferedImage texturePattern = getImage("./images/texturePatterns/RANDOM.jpg");
